...
import paymentsAxios from "./payment";
...
const Page = () => {
    ...
    const fetchData = async (page: number) => {
        ...
        try {
            ...
            const data = await paymentsAxios(page, rowsPerPage);
        ...
        <div className=" flex  items-center">
            ...
            <div className="w-full flex flex-col items-center">
                <div className="p-6 w-[85%] bg-white   rounded-xl shadow-md">
                    <h3 className="font-sans text-3xl font-semibold px-3 py-4">View All Payments</h3>
